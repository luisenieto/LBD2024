...
DROP DATABASE IF EXISTS `LBD2024`;
CREATE DATABASE `LBD2024`;

USE information_schema;

SELECT * FROM table_constraints
WHERE constraint_schema = 'LBD2024';
...
SELECT * FROM information_schema.table_constraints
WHERE constraint_schema = 'LBD2024'; -- no figura la default
...
SELECT * FROM information_schema.key_column_usage
WHERE constraint_schema = 'LBD2024'; -- no figura la CHECK
